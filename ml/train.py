...
DATA_PATH = os.path.join(BASE_DIR, "data", "raw_customer_data.csv")
...
joblib.dump(X_train.mean(), os.path.join(MODEL_DIR, "feature_means.pkl"))
joblib.dump(X_train.std(), os.path.join(MODEL_DIR, "feature_stds.pkl"))
